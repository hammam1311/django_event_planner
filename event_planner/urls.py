...
# ............................api .....................
    ...
    path('organizer_list/<int:event_id>/', views.EventOrganizersList.as_view(), name="organizer-list"),
    ...
    path('api/event/<int:event_id>/book', views.BookEventView.as_view(), name="book-event-api"),
    path('api/event/booked', views.BookedList.as_view(), name="booked-event-api"),
